...
public class ProcessoAPIController {
    ...
    private final ProcessoProducer processoProducer;

    public ProcessoAPIController(ProcessoGrau1API processoGrau1API, ProcessoProducer processoProducer) {
        this.processoGrau1API = processoGrau1API;
        this.processoProducer = processoProducer;
    }
    ...
    public ResponseEntity<Object> getProcessoByNumero(@PathVariable String numeroProcesso) {
        ...
        try {
            processoProducer.send(numeroProcesso, correlationId);

...
VALUES
    (1,'advogado_fisico', 0, 'Pinheiros', '05422-000', 'São Paulo', 'Rua dos Pinheiros', '123',
     ...
     '98765432100', 'Leticia Fonseca', '765432198', 123456, 1,
    ...
    (2,'usuario_fisico', 0, 'Bela Vista', '01310-200', 'São Paulo', 'Avenida Paulista', '200',
     ...
     '46009286875', 'Maria Souza', '115233449', NULL, 0,
    ...
    (3,'advogado_juridico', 0, 'Bela Vista', '01310-200', 'São Paulo', 'Rua Haddock Lobo', '150',
     ...
     NULL, 'Felipe Lauriano Rocha Marqueze', NULL, 509556, 2,
    ...
    (7,'usuario_fisico', 0, 'Santana', '02012-020', 'São Paulo', 'Rua Voluntários da Pátria', '321',
     ...
     '12345678910', 'João Pereira', '445566779', NULL, 0,
    ...
    (8,'usuario_fisico', 0, 'Centro', '20040-010', 'Rio de Janeiro', 'Rua do Ouvidor', '45',
     ...
     '10987654321', 'Ana Costa', '889977661', NULL, 0,
    ...
    (9,'usuario_fisico', 0, 'Boa Viagem', '51020-020', 'Recife', 'Avenida Conselheiro Aguiar', '101',
     ...
     '32165498700', 'Marcos Silva', '223344559', NULL, 0,
    ...
    (10,'advogado_fisico', 0, 'Lapa', '05075-010', 'São Paulo', 'Rua Guaicurus', '77',
     ...
     '98732165400', 'Carla Menezes', '886677889', 785412, 1,
    ...
    (11,'advogado_fisico', 0, 'Barra', '22631-000', 'Rio de Janeiro', 'Avenida das Américas', '1500',
     ...
     '65498732100', 'Ricardo Oliveira', '112244559', 963258, 1,
...
VALUES
    ...
    (6, 'Não informado', 'Criminal', 'Roubo', 'Não informado', 'Ação Penal - Procedimento Ordinário', '2024/000479', 'Direito da mulher', '26/02/2024 às 12:59 - Livre', 'Não informado', 'Foro de Carapicuíba', 'Não indiciado', 'CAMILE DE LIMA E SILVA BONILHA', 0.00, '1500481-56.2024.8.26.0127', 'Não informado', 'Não informado', NULL, '2ª Vara Criminal','2025-01-10 09:15:22','2025-01-17 11:37:05'),
    (7, 'Não informado', 'Cível', 'Práticas Abusivas', 'Não informado', 'Procedimento Comum Cível', '2024/001667', 'Prática abusiva', '07/08/2024 às 00:04 - Livre', 'Não informado', 'Foro de Mongaguá', 'Não indiciado', 'NATÁLIA DOMINGUES TAKAKI', 81745.10, '1002506-61.2024.8.26.0366', 'Jarbas Marqueze Advogado: Jarbas Alessandro Rocha Marqueze Advogada: Karla Janayna Rocha Marqueze Advogado: Felipe Lauriano Rocha Marqueze', 'Condominio Edificio Residencial Miami & Florida Advogado: Carlos Alberto Fernandes da Silva Advogado: Artur Fernandes Campos Rodrigues', 81745.10, '2ª Vara','2025-01-10 09:15:22','2025-01-17 11:37:05'),
    (8, 'Não informado', 'Cível', 'DIREITO PROCESSUAL CIVIL E DO TRABALHO', 'Não informado', 'Procedimento Comum Cível', '2023/002051', NULL, '04/10/2023 às 16:04 - Livre', 'Não informado', 'Foro de Presidente Prudente', 'Não indiciado', 'LUIZ AUGUSTO ESTEVES DE MELLO', 91200.00, '1019300-37.2023.8.26.0482', 'Edielson de Oliveira da Silva Advogado: Bruno Bravo Estacio', 'Não informado', 91200.00, '1ª Vara Cível','2025-01-10 09:15:22','2025-01-17 11:37:05'),
    (9, 'Não informado', 'Cível', 'Seguro', 'Não informado', 'Monitória', '2019/000510', NULL, '25/02/2019 às 12:48 - Livre', 'Não informado', 'Foro Regional de Vila Mimosa', 'Não indiciado', 'DANIELLA APARECIDA SORIANO UCCELLI', 14591.55, '1001275-45.2019.8.26.0084', 'BRADESCO SAÚDE S/A Advogado: Walter Roberto Hee Advogado: Walter Roberto Lodi Hee', 'Americaexport - Exportação e Importação Eireli Advogado: Gilmar Luiz Panatto', 14591.55, '4ª Vara','2025-01-10 09:15:22','2025-01-17 11:37:05'),
    (10, 'Não informado', 'Cível', 'Levantamento de Valor', 'Não informado', 'Alvará Judicial - Lei 6858/80', '2024/002371', NULL, '27/09/2024 às 12:19 - Livre', 'Não informado', 'Foro Regional IX - Vila Prudente', 'Não indiciado', 'Claudia Akemi Okoda Oshiro Kato', 1000.00, '1013970-86.2024.8.26.0009', 'Não informado', 'Não informado', 1000.00, '4ª Vara Cível','2025-01-10 09:15:22','2025-01-17 11:37:05'),
    (11, 'Não informado', 'Cível', 'Contratos Bancários', 'Não informado', 'Procedimento Comum Cível', '2024/001791', NULL, '15/07/2024 às 10:16 - Livre', 'Não informado', 'Foro Regional IX - Vila Prudente', 'Não indiciado', 'Cristiane Sampaio Alves Mascari Bonilha', 58559.52, '1010105-55.2024.8.26.0009', 'Luiza Maria da Silva de Souza Advogado: Felipe Lauriano Rocha Marqueze', 'Não informado', 58559.52, '3ª Vara Cível','2025-01-10 09:15:22','2025-01-17 11:37:05'),
    (12, 'Não informado', 'Cível', 'Locação de Imóvel', 'Não informado', 'Procedimento do Juizado Especial Cível', '2025/000809', NULL, '24/02/2025 às 10:59 - Livre', 'Não informado', 'Foro Regional VI - Penha de França', 'Não indiciado', 'GUSTAVO SAMPAIO CORREIA', 26456.23, '1021187-86.2024.8.26.0008', 'Não informado', 'Não informado', 26456.23, '1ª Vara do Juizado Especial Cível','2025-01-10 09:15:22','2025-01-17 11:37:05');
